<template>
  ...
  >
    <div
      ...
      class="absolute top-0 left-1/2 flex pt-5 h-16 items-center justify-center sm:text-md xl:text-xl text-white flex-col cursor-pointer"
      ...
      <div :class="`${prefixCls}-entry`" v-show="!showDate">
        <div :class="`${prefixCls}-entry-content`">
          <div :class="`${prefixCls}-entry__header enter-x`">
            <UserIcon :size="70" :class="`${prefixCls}-entry__header-img`" />
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'LockPage',
    components: { LockOutlined, InputPassword: Input.Password, UserIcon },
